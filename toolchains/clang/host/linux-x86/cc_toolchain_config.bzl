...
_cc_toolchain_config = rule(
    ...
    attrs = {
        ...
        "_auto_zero_initialize": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:auto_zero_initialize_env",
        ),
        "_auto_pattern_initialize": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:auto_pattern_initialize_env",
        ),
        "_auto_uninitialize": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:auto_uninitialize_env",
        ),
        "_use_ccache": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:use_ccache_env",
        ),
        "_llvm_next": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:llvm_next_env",
        ),
        "_allow_unknown_warning_option": attr.label(
            default = "//build/bazel/toolchains/clang/host/linux-x86:allow_unknown_warning_option_env",
        ),
