...
auto_pattern_initialize_flags_verification_test = analysistest.make(
    ...
    config_settings = {
        "@//build/bazel/toolchains/clang/host/linux-x86:auto_pattern_initialize_env": True,
    },
)
...
auto_zero_initialize_flags_verification_test = analysistest.make(
    ...
    config_settings = {
        "@//build/bazel/toolchains/clang/host/linux-x86:auto_zero_initialize_env": True,
    },
)
...
auto_uninitialize_flags_verification_test = analysistest.make(
    ...
    config_settings = {
        "@//build/bazel/toolchains/clang/host/linux-x86:auto_uninitialize_env": True,
    },
)
...
independent_global_flags_verification_test = analysistest.make(
    ...
    config_settings = {
        "@//build/bazel/toolchains/clang/host/linux-x86:use_ccache_env": True,
        "@//build/bazel/toolchains/clang/host/linux-x86:llvm_next_env": True,
        "@//build/bazel/toolchains/clang/host/linux-x86:allow_unknown_warning_option_env": True,
    },
)
